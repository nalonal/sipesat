...
$(document).ready(function(){
    ...
    $("#addNewItem").click(function(e){
        ...
        if(!itemName || !itemQuantity || !itemPrice || !kategori || !itemCode || !itemMinimal){
            ...
            !kategori ? $("#kategori").text("required") : "";
            !itemMinimal ? $("#itemMinimal").text("required") : "";
        ...
        $.ajax({
            type: "post",
            url: appRoot+"obat/add",
            data:{itemName:itemName, itemQuantity:itemQuantity, itemKategori:itemKategori, itemPrice:itemPrice, itemDescription:itemDescription, itemCode:itemCode, itemMinimal:itemMinimal},
...
function lilt(url){
    ...
    $.ajax({
        type:'get',
        url: url ? url : appRoot+"obat/obatlilt/",
