 ...
 */
class Opnamedb extends CI_Model {
     ...
     * @return boolean
     */
    public function add($_iN, $_iC, $desc, $q, $_up, $_tp, $cn, $ref) {
        $data = ['itemName' => $_iN, 'itemCode' => $_iC, 'description' => $desc, 'quantity' => $q, 'unitPrice' => $_up, 'totalPrice' => $_tp, 'cust_name'=>$cn, 'ref'=>$ref];
