...
class Obatdb extends CI_Model{
    ...
    */
     ...
     * @return boolean
     */
    public function add($itemName, $itemQuantity, $itemPrice, $kategori, $itemDescription, $itemCode, $itemMinimal){
        $data = ['name'=>$itemName, 'quantity'=>$itemQuantity, 'kategori'=>$kategori, 'unitPrice'=>$itemPrice, 'description'=>$itemDescription, 'code'=>$itemCode, 'minimal'=>$itemMinimal];
    ...
    */
    ...
    public function incrementItem($itemId, $numberToadd){
        $q = "UPDATE obat SET quantity = quantity + ? WHERE id = ?";
    ...
    */
    ...
    public function decrementItem($itemCode, $numberToRemove){
        $q = "UPDATE obat SET quantity = quantity - ? WHERE code = ?";
   ...
   public function newstock($itemId, $qty){
       $q = "UPDATE obat SET quantity = quantity + $qty WHERE id = ?";
