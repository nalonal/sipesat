...
class Search extends CI_Controller{
    ...
    public function __construct() {
        ...
        $this->load->model(['transaction', 'item', 'obatdb']);
    ...
    */
    ...
    public function obatSearch(){
        $data['allItems'] = $this->obatdb->itemsearch($this->value);
        $data['sn'] = 1;
        $data['cum_total'] = $this->obatdb->getItemsCumTotal();
        
        $json['itemsListTable'] = $data['allItems'] ? $this->load->view('obat/obatlisttable', $data, TRUE) : "No match found";
