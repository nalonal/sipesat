...
class Items extends CI_Controller{
    ...
    */
    ...
    public function add(){
        ...
        $this->form_validation->set_rules('itemKategori', 'kategori', ['trim', 'max_length[90]', 'is_unique[items.code]']);
        ...
        if($this->form_validation->run() !== FALSE){
             ...
             */
            $insertedId = $this->item->add(set_value('itemName'), set_value('itemQuantity'), set_value('itemPrice'), set_value('itemKategori'), set_value('itemDescription'), set_value('itemCode'), set_value('itemMinimal'));
