            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="col-sm-2 form-inline form-group-sm">
                        <button class="btn btn-primary btn-sm" id='createItem'>Masukkan Daftar Obat</button>
                    </div>
            ...
            <div class="col-sm-4 hidden" id='createNewItemDiv'>
                <div class="well">
                    ...
                    <form name="addNewItemForm" id="addNewItemForm" role="form">
                        ...
                        <div class="row">
                            <div class="col-sm-12 form-group-sm">
                                <label for="itemName">Nama Barangx</label>
                        ...
                        <div class="row">
                            <div class="col-sm-12 form-group-sm">
                                <label for="itemDescription" class="">Deskripsi (Optional)</label>
...
<!--end of modal-->
<script src="<?=base_url()?>public/js/obat.js"></script>