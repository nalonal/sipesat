...
<html>
    <head>
        ...
        <!-- Favicon -->
        <link rel="shortcut icon" href="<?=base_url()?>public/images/ikon.png">
        <!-- favicon ends -->
            ...
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?=base_url()?>" style="margin-top:-15px">
                        <img src="<?=base_url()?>public/images/logo_black.png" alt="logo" class="img-responsive" width="180px" style="margin-top: 7px;">
                    </a>
                </div>
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                        ...
                        <li class="<?= $pageTitle == 'Items' ? 'active' : '' ?>">
                            <a href="<?= site_url('items') ?>">
                                <i class="fa fa-briefcase"></i>
                                 Alat Tulis Kantor <i style="color: red">(<?php echo $item ?>)</i>
                            </a>
                        </li>

                        <li class="<?= $pageTitle == 'Obat' ? 'active' : '' ?>">
                            <a href="<?= site_url('obat') ?>">
                                <i class="fa fa-medkit"></i>
                                Obat-obatan <i style="color: red">(<?php echo $obat ?>)</i>
                            </a>
                        </li>
                    ...
                    -->
                        ...
                        <li class="<?= $pageTitle == 'Opname' ? 'active' : '' ?>">
                            <a href="<?= site_url('opname') ?>">
                ...
                <div class="col-sm-2 sidenav hidden-xs mySideNav">
                    ...
                    <ul class="nav nav-pills nav-stacked pointer">
                        ...
                        <li class="<?= $pageTitle == 'Items' ? 'active' : '' ?>">
                            <a href="<?= site_url('items') ?>">
                                <i class="fa fa-briefcase"></i>
                                Alat Tulis Kantor<?php if($item != 0){ ?><i style="color: red">(<?php echo $item ?>)</i><?php } ?>
                            </a>
                        </li>
                        ...
                        <li class="<?= $pageTitle == 'Obat' ? 'active' : '' ?>">
                            <a href="<?= site_url('obat') ?>">
                                <i class="fa fa-medkit"></i>
                                Obat-obatan<?php if($obat != 0){ ?><i style="color: red">(<?php echo $obat ?>)</i><?php } ?>
                            </a>
                        </li>
        ...
        <footer class="container-fluid text-center hidden-print">
            <p>
                <i class="fa fa-copyright"></i>
                    Subbagian Pengelolaan Barang Milik Negara Umum dan Barang Persediaan (2018)
            </p>
        </footer>
