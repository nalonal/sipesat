            ...
            <div class="row">
                <div class="col-sm-3">
                    <span class="pointer text-primary">
                        <button class='btn btn-primary btn-sm' id='showTransForm'><i class="fa fa-plus"></i> Transaksi Baru</button>
                    </span>
                </div>
                <div class="col-sm-3">
                    <span class="pointer text-primary">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    -->
                                        <div class="col-sm-3 form-group-sm">
                                            ...
                                            <select class="form-control checkField" id="custName">
                                                <option value="">---</option>
                                                <option value="Subbag Urusan Dalam">Subbag Urusan Dalam</option>
                                                <option value="Subbag Tata Usaha">Subbag Tata Usaha</option>
                                                <option value="Subbag Administrasi Umum">Subbag Administrasi Umum</option>
                                            </select>
                ...
                <div class="col-sm-12">
                    ...
                    <div class="col-sm-5 form-group-sm form-inline">
                        ...
                        <select id="transListSortBy" class="form-control">
                            ...
                            <option value="cust_name-DESC">Pengguna (Highest first)</option>
                            <option value="cust_name-ASC">Pengguna (Lowest first)</option>
                        </select>
                    </div>
